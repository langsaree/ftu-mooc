                            ...
                            <div class="pmb-block">
                                ...
                                <div class="pmbb-body p-l-30">
                                    ...
                                    <div class="pmbb-edit">
                                        ...
                                        <div class="m-t-10">
                                            <button class="btn btn-primary btn-sm" onclick="UpdateDescriptions()">record
                                            </button>
                                            <button data-pmb-action="reset" class="btn btn-link btn-sm">cancel</button>
                                        </div>
                            ...
                            <div class="pmb-block">
                                ...
                                <div class="pmbb-body p-l-30">
                                        ...
                                        <dl class="dl-horizontal">
                                            ...
                                            <dd>
                                                @if($course->course_pretest == 0)
                                                    <span class='c-red'>There is no test before studying</span>
                                                @else
                                                    <span class='c-green'>There is a test before studying</span>
                                                @endif
                                            </dd>
                                        </dl>
                                        <dl class="dl-horizontal">
                                            ...
                                            <dd>
                                                @if($course->course_posttest == 0)
                                                    <span class='c-red'>There is no test after study</span>
                                                @else
                                    ...
                                    <div class="pmbb-edit">
                                            ...
                                            <dd>
                                                <div class="fg-line">
                                                    ...
                                                    <select class="form-control" name="course_pretest"
                                                        ...
                                                        <option value="0" @if($course->course_pretest == 0) selected @endif>There is no test before studying</option>
                                                        <option value="1" @if($course->course_pretest == 1) selected @endif>There is a test before studying
                                                        </option>
                                        ...
                                        <dl class="dl-horizontal">
                                            <dt class="p-t-10">Test after class</dt>
                                            <dd>
                                                <div class="fg-line" id="course_programs_g">
                                                    <select class="form-control" name="course_posttest"
                                                            id="course_posttest">

                                                        <option value="0" @if($course->course_posttest == 0) selected @endif>There is no test after study
                                                        </option>
                                                        <option value="1" @if($course->course_posttest == 1) selected @endif>There is a test after study</option>
